...
const ORDER_COLUMNS =
  'id, status, payment_status, payment_method, total, subtotal, shipping_price, discount_amount, shipping_method_name, address_id, shipping_address, notes, tracking_code, carrier, shipped_at, delivered_at, track7_synced_at, track7_last_status, payment_proof_pending, created_at, updated_at'
