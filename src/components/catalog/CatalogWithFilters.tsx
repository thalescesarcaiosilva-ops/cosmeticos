...
type CatalogWithFiltersProps = {
  /** Caminho base da página, ex.: `/colecoes/maquiagem` ou `/dior` */
  basePath: string
  ...
  /** Esconde o filtro de marca (útil em páginas de marca). */
  ...
  return (
    <section aria-label="Catálogo de produtos">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <CollectionFiltersMobile meta={meta} hideBrandFilter={hideBrandFilter} />
      </div>
